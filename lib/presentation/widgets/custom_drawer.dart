...
final List<SubCategory> subCategories = [
  SubCategory(id: 0, label: 'ANY', value: null),
  SubCategory(id: 1, label: 'ARCHER_COAT', value: ItemMinorClass.ARCHER_COAT),
  SubCategory(id: 2, label: 'ARCHER_HAT', value: ItemMinorClass.ARCHER_HAT),
  SubCategory(id: 3, label: 'AXE', value: ItemMinorClass.AXE),
  SubCategory(id: 4, label: 'BACKSWORD', value: ItemMinorClass.BACKSWORD),
  SubCategory(id: 5, label: 'BAG', value: ItemMinorClass.BAG),
  SubCategory(id: 6, label: 'BLADE', value: ItemMinorClass.BLADE),
  SubCategory(id: 7, label: 'BOOTS', value: ItemMinorClass.BOOTS),
  SubCategory(id: 8, label: 'BOW', value: ItemMinorClass.BOW),
  SubCategory(id: 9, label: 'BRACELET', value: ItemMinorClass.BRACELET),
  SubCategory(id: 10, label: 'CLUB', value: ItemMinorClass.CLUB),
  SubCategory(id: 11, label: 'DAGGER', value: ItemMinorClass.DAGGER),
  SubCategory(id: 12, label: 'DRAGON_BALL', value: ItemMinorClass.DRAGON_BALL),
  SubCategory(id: 13, label: 'DRAGON_CLAW', value: ItemMinorClass.DRAGON_CLAW),
  SubCategory(id: 14, label: 'DRAGON_GEM', value: ItemMinorClass.DRAGON_GEM),
  SubCategory(id: 15, label: 'EARRING', value: ItemMinorClass.EARRING),
  SubCategory(id: 16, label: 'FURY_GEM', value: ItemMinorClass.FURY_GEM),
  SubCategory(id: 17, label: 'GLAIVE', value: ItemMinorClass.GLAIVE),
  SubCategory(id: 18, label: 'HALBERT', value: ItemMinorClass.HALBERT),
  SubCategory(id: 19, label: 'HAMMER', value: ItemMinorClass.HAMMER),
  SubCategory(id: 20, label: 'HEAVY_RING', value: ItemMinorClass.HEAVY_RING),
  SubCategory(id: 21, label: 'HOOK', value: ItemMinorClass.HOOK),
  SubCategory(id: 22, label: 'KYLIN_GEM', value: ItemMinorClass.KYLIN_GEM),
  SubCategory(id: 22, label: 'LONG HAMMER', value: ItemMinorClass.LONG_HAMMER),
  SubCategory(id: 23, label: 'MOON_GEM', value: ItemMinorClass.MOON_GEM),
  SubCategory(id: 24, label: 'NECKLACE', value: ItemMinorClass.NECKLACE),
  SubCategory(id: 25, label: 'OTHER', value: ItemMinorClass.OTHER),
  SubCategory(id: 26, label: 'PACK', value: ItemMinorClass.PACK),
  SubCategory(id: 27, label: 'PHOENIX_GEM', value: ItemMinorClass.PHOENIX_GEM),
  SubCategory(id: 28, label: 'POLEAXE', value: ItemMinorClass.POLEAXE),
  SubCategory(id: 29, label: 'POTION', value: ItemMinorClass.POTION),
  SubCategory(id: 30, label: 'QUEST_ITEM', value: ItemMinorClass.QUEST_ITEM),
  SubCategory(id: 31, label: 'RAINBOW_GEM', value: ItemMinorClass.RAINBOW_GEM),
  SubCategory(id: 32, label: 'RING', value: ItemMinorClass.RING),
  SubCategory(id: 33, label: 'SCEPTER', value: ItemMinorClass.SCEPTER),
  SubCategory(id: 34, label: 'SHIELD', value: ItemMinorClass.SHIELD),
  SubCategory(id: 35, label: 'SKILL_BOOK', value: ItemMinorClass.SKILL_BOOK),
  SubCategory(id: 36, label: 'SPEAR', value: ItemMinorClass.SPEAR),
  SubCategory(id: 37, label: 'SWORD', value: ItemMinorClass.SWORD),
  SubCategory(id: 38, label: 'TAOIST_CAP', value: ItemMinorClass.TAOIST_CAP),
  SubCategory(id: 39, label: 'TAOIST_ROBE', value: ItemMinorClass.TAOIST_ROBE),
  SubCategory(id: 40, label: 'TROJAN_ARMOR', value: ItemMinorClass.TROJAN_ARMOR),
  SubCategory(id: 41, label: 'TROJAN_CORONET', value: ItemMinorClass.TROJAN_CORONET),
  SubCategory(id: 42, label: 'VIOLET_GEM', value: ItemMinorClass.VIOLET_GEM),
  SubCategory(id: 43, label: 'WAND', value: ItemMinorClass.WAND),
  SubCategory(id: 44, label: 'WARRIOR_ARMOR', value: ItemMinorClass.WARRIOR_ARMOR),
  SubCategory(id: 45, label: 'WARRIOR_HELMET', value: ItemMinorClass.WARRIOR_HELMET),
  SubCategory(id: 46, label: 'WHIP', value: ItemMinorClass.WHIP),
...
class _SelectSubCategory extends StatefulWidget {
...
class _SelectSubCategoryState extends State<_SelectSubCategory> {
  int? selectedOption;
   @override
  void initState() {
    super.initState();
    selectedOption = widget.subCategorySelected;
  }
  @override
  Widget build(BuildContext context) {
    List<DropdownMenuItem<int>> dropdownItemsRubro =
        widget.subCategory!.map((server) {
      return DropdownMenuItem<int>(
        value: server.id,
        child: Text(
          server.label,
